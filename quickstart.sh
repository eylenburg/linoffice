...
dependencies_main() {
  ...
  if ! python3 -c "import PySide6" 2>/dev/null; then
    if [ "$USE_IMMUTABLE" -eq 1 ]; then
      ...
      try_install_any python3-pyside6 python-pyside6 python3-qtpy-pyside6 python3-pyside6.qtcore python3-pyside6.qtwidgets python-pyside6.qtuitools pyside6 qt6-tools || true
      if ! python3 -c "import PySide6" 2>/dev/null; then
